...
1,122 unit tests and production build. The explicit real-PostgreSQL run passes
all 61 opt-in integration cases after all 28 migrations apply from empty.
...
| Test suite                                 | Done      | **1,122 unit tests passed and 61 opt-in PostgreSQL integration tests skipped; explicit real-PostgreSQL suite 61/61 after all 28 migrations** (verified 2026-08-11)                                                                                                                                                                                                                                                        |
