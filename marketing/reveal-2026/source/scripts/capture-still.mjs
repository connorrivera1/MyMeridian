...
// nosemgrep: typescript.react.security.react-insecure-request.react-insecure-request -- This talks solely to the local Chrome CDP process used to render a still.
